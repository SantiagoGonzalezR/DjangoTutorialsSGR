...
from .views import HomePageView, AboutPageView, ContactPageView, ImageViewNoDI, ProductIndexView, ProductShowView, ProductCreateView, ProductCreatedView, CartView, CartRemoveAllView, ImageViewFactory
urlpatterns = [
